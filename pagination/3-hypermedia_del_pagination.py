...
class Server:
    ...
    def indexed_dataset(self) -> Dict[int, List]:
        ...
        FIRST 1000 ROWS ONLY (truncated dataset). This is important
        for the checker that expects a truncated index.
        """
        if self.__indexed_dataset is None:
            dataset = self.dataset()
            truncated_dataset = dataset[:1000]
            # Index the truncated slice, not the full dataset
    ...
    def get_hyper_index(
        ...
        This method is resilient to deletions between queries.
        ...
        # Collect up to page_size items that still exist
